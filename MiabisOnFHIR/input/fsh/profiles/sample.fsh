...
* collection.bodySite.concept.coding obeys SpecimenOntologyInvariant
* collection.bodySite.concept.coding 0..1 MS 
* collection.bodySite.concept.coding.system ^definition = "Name of ontology used for describing the anatomical source of the sample material, for example, ICD-O-3 topography code"
* collection.bodySite.concept.coding.version ^definition = "Version of the ontology used for describing the anatomical source of the sample material"
* collection.bodySite.concept.coding.code ^definition = "Anatomical site code from the selected anatomical site ontology version"
* collection.bodySite.concept.coding.display ^definition = "Description from the selected anatomical site ontology code"
